...
export function UpdateRoomStatusDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] max-w-[95vw] max-h-[90vh] flex flex-col p-0">
        ...
        <DialogFooter className="p-6 pt-2">
          ...
          <Button onClick={handleSubmit(onSubmit)} disabled={isSubmitting || !watchedValues.statusId}>
            {isSubmitting ? (
              <>
