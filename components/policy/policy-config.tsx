...
export function PolicyConfig() {
  const { policySettings, updateStandardPolicy, updateCustomPolicy, updateMixedPolicy } = usePolicy()
      ...
      <Alert>
        ...
        <AlertDescription className="text-sm">
          ...
          <span className="ml-2 text-muted-foreground">
            (Select a policy type and use the confirmation buttons below to apply)
          </span>
        </AlertDescription>
      </Alert>
        ...
        <TabsContent value="mixed" className="space-y-6">
          <div className="space-y-6">
            <Alert>
              ...
              <AlertDescription className="text-sm">
                Mixed policy allows you to offer both nightly and hourly rates. Configure both policies above, then set
                the default mode for new bookings.
              </AlertDescription>
            </Alert>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <p>
                    Check-in: {policySettings.standardPolicy.checkInStart} - {policySettings.standardPolicy.checkInEnd}
                  </p>
                  <p>
